...
class StudentController extends Controller
{
    ...
    {
        $request->validate(['admision_number'=>'required',
        'first_name'=>'required',
        'last_name'=>'required',
        'gender'=>'required',
        'mail'=>'required|mail',
        'house_id'=>'required'|'unique:students,house_id',
        'grade_id'=>'required'|'unique:students,grade_id',
        'subject_id'=>'required'|'unique:students,subject_id',
