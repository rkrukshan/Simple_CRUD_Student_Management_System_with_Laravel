...
<body>
    <div id="carouselExampleIndicators" class="carousel slide align-center">
      ...
      <tr>
        <td width=25%></td>
      <td class="d-flex p-2" width="50%"><h3><p><center>A school management system sounds like it is interchangeable with student management, but the difference comes from what information you manage:
