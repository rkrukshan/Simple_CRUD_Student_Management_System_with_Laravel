...
<html lang="en">
    ...
    <table border="1" class="table table-striped table table-hover table-responsive">
        ...
        <td>
                ...
                <tr>
                    <center>
                    <td>{{ $student_subject->admision_number }}</td>
                    <td>{{ $student_subject->first_name }}</td>
                    ...
                    <td>{{ $student->nic }}</td>
                    <td><a href="{{ route('student.subject.show',$student->id,$subjects->id) }}">{{ $student->subjects->subject_name }}</a></td>
