...
<table border="1" class="table table-striped table table-hover table-responsive">
    ...
    <td>
            ...
            <tr>
                <center><h5><span for="student">Student Name</span></h5></center><br>
                <center><h5><span for="student" class="badge badge-pill badge-primary"> {{ $student->first_name }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $student->last_name }}</span></h5></center>
