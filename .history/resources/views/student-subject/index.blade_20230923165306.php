...
<html lang="en">
    <table border="1" class="table table-striped table table-hover table-responsive">
        ...
        <td>
                ...
                <tr>
<label for="student_id">  admision_number</label><input type="text" name="admision_number" id="" class="form-control" value="{{ $student->admision_number }}" readonly>
...
<td><a href="{{route('student.show',[$student ->id ])}}">subject1</a></td><br>

<td><a href="{{route('student.subject.show',[$student ->id, 0 ])}}">subject</a></td><br>
