...
<table border="1" class="table table-striped table table-hover table-responsive">
    ...
    <td>
            ...
            <tr>
                <center><h5><p for="student">Student Name</p></h5></center><br>
                <center><h5><p for="student" class="badge badge-pill badge-darkbadge badge-pill badge-primary"> {{ $student->first_name }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $student->last_name }}</p></h5></center>
