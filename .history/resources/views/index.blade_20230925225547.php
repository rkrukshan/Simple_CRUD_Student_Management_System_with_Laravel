                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ route('student.index') }}"></a></li>
                                    <li><a class="dropdown-item" href="{{ route('subject.index') }}"></a></li>
                                    <li><a class="dropdown-item" href="{{ route('house.index') }}"></a></li>
                                    <li><a class="dropdown-item" href="{{ route('grade.index') }}"></a></li>
                                    <li>
