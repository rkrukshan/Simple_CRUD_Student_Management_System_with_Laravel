                  ...
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li>l<a class="dropdown-item" href="{{ route('subject.index') }}">Subject</a><li><i
                        <li>l<a class="dropdown-item" href="{{ route('grade.index') }}">Grade</a><li><i
                        <li>l<a class="dropdown-item" href="{{ route('house.index') }}">House</a><li><i
                        <li>l<a class="dropdown-item" href="{{ route('subject.index') }}"></a><li><i
