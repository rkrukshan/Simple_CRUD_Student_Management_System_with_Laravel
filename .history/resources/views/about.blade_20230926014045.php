    ...
    <div id="carouselExampleIndicators" class="carousel slide align-center">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{asset( '/images/pic1.jpeg') }}" width="550" height="775" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="{{asset( '/images/pic2.jpeg') }}" width="550" height="775" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="{{asset( '/images/pic3.jpeg') }}" width="550" height="775" class="d-block w-100" alt="...">
          </div>
        </div>
