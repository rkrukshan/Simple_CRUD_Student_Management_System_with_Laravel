...
<table class="table table-striped table-hover">
    ...
    <tr>
        ...
        <form action="{{ route('house.destroy',$house) }}" method="POST">
            @csrf
            @method('delete')
        <td><button type="button" class="btn btn-outline-info"><a href="{{ route('house.show',$house) }}">show</a></button>&nbsp;&nb&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button type="button" class="btn btn-outline-warning"><a href="{{ route('house.edit',$house) }}">edit</a></button>&nbsp;&nb&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
