...
<table class="table table-striped table-hover">
    ...
    <tr>
        ...
        <form action="{{ route('house.destroy',$house) }}" method="POST">
            @csrf
            @method('delete')
        <td><button type="button" class="btn btn-info"><a href="{{ route('house.show',$house) }}">show</a></button>
        <button type="button" class="btn btn-"><a href="{{ route('house.edit',$house) }}">edit</a></button>
