...
<table class="table table-striped table table-hover table-responsive">
    <tr>
        ...
        <form action="{{ route('house.destroy',$house) }}" method="POST">
            @csrf
            @method('delete')
        <td><a href="{{ route('house.show',$house) }}"><i class="fa fa-eye"></i><button type="button" class="btn btn-outline-info btn-lg">show</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="{{ route('house.edit',$house) }}"><i class="fa fa-pencil"></i><button type="button" class="btn btn-outline-warning btn-lg">edit</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
