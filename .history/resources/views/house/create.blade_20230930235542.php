...
<center>
    <form action="{{ route('house.store') }}" method="POST">
        @csrf
    <lable>House Name</lable><input type="text" name="house_name" class="form-control" val><br>
...
<div class="alert alert-danger">
    ...
    <lable>House Order</lable><input type="text" name="house_order" class="form-control" val><br>
