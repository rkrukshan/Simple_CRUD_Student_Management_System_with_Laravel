...
<body>
    <div id="carouselExampleIndicators" class="carousel slide align-center">
      ...
      <tr>
        <td width=25%></td>
      <td width="50%">h<p><center>A school management system sounds like it is interchangeable with student management, but the difference comes from what information you manage:</td>
