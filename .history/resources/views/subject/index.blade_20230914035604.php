...
<table class="table">
    ...
    <tr>
        ...
        <form action="{{ route('subject.destroy',$subject) }}" method="POST" class="form">
            @csrf
            @method('delete')
            <td><button type="submit" class="btn btn-primary"><a class="btn btn-primary" href="{{ route('subject.edit',$subject) }}">edit</button></a></td>  <td><button type="submit" class="btn btn-primary"><a class="btn btn-primary" href="{{ route('subject.show',$subject) }}">show</button></a></td>  <td><button type="submit" class="btn btn-danger"><a class="btn btn-danger" href="">delete</button></a></td>
