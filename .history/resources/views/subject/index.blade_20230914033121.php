...
<table class="table">
    ...
    <button type="submit" class="btn btn-primary"><a class="btn btn-primary btn-lg" href="{{ route('subject.create') }}">show</button></a>
    <button type="submit" class="btn btn-primary"><a class="btn btn-primary btn-lg" href="{{ route('subject.create') }}">edit</button></a>
