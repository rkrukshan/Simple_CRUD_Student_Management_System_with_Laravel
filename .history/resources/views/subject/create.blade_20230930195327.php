...
<form action="{{ route('subject.store') }}" method="POST" class="form">
    ...
    <table>
        <center>
            ...
            <label for="subject_name">Subject index</label><input type="text" name="subject_index"
            ...
            <label for="subject_order">Subject Order</label><input type="text" name="subject_order" class="form-controll">
