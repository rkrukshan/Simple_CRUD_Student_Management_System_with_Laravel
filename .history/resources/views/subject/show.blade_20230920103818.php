...
<table class="table">
    ...
    <label for="subject_index">subject name</label><input type="text" name="subject_index" value="{{ $subjects->subject_index }}" class="form-control" readonly><br>
    ...
    <center><a class="link-light" href="{{ $subjects->subject_order }}" ><button type="submit" class="btn btn-secondary">Back</button></a></center><br>
