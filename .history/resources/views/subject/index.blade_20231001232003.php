...
<table class="table table-striped table table-hover table-responsive">
    ...
    <tr>
        ...
        <form action="{{ route('subject.destroy',$subject) }}" method="POST" class="form">
            @csrf
            @method('delete')
        <td><a href="{{ route('subject.show',$subject) }}"><button type="button" class="btn btn-outline-warning"><i class="fa fa-pencil"></i>edit</button><i class="fa fa-eye"></i>show</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
