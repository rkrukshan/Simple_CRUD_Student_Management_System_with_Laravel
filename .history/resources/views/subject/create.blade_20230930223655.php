...
<form action="{{ route('subject.store') }}" method="POST" class="form">
    ...
    <table>
        <center>
            ...
            <input type="text" name="subject_index"class="form-control" va><br>
            ...
            <input type="text" name="subject_name"class="form-control" va><br>
            ...
            <input type="text" name="subject_order" class="form-control" va>
