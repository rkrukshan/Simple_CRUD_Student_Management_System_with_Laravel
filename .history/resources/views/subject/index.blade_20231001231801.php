...
<table class="table table-striped table table-hover table-responsive">
    ...
    <tr>
        ...
        <form action="{{ route('subject.destroy',$subject) }}" method="POST" class="form">
            @csrf
            @method('delete')
        <td><a href="{{ route('subject.show',$subject) }}"><i class="fa fa-eye"></i>show</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="{{ route('subject.edit',$subject) }}"><button type="button" class="btn btn-outline-warning"></a><i class="fa fa-pencil"></i>edit</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <button type="submit" class="btn btn-outline-danger btn-lg"><i class="fa fa-trash"></i>delete</a></button></td>
    </form>

    <a href="{{ route('subject.edit',$subject) }}"><button type="button" class="btn btn-outline-warning"><i class="fa fa-pencil"></i>edit</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
