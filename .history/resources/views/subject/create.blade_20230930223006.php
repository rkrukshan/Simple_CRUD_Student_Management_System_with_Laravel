...
<form action="{{ route('subject.store') }}" method="POST" class="form">
    @csrf
        ...
        <center>
            ...
            {{--  <input type="text" class="form-control" name="subject_index" value="{{ old('subject_index') }}" ><br>  --}}
            <label for="admision_number">Admision Number</label><input type="text" name="subject_index" id=""class="form-control" value="{{ old('admision_number') }}"><br>
