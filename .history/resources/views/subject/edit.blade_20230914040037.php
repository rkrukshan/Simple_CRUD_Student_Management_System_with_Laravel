...
<center>
   ...
   <lable>Subject Index</lable><input type="text" name="subject_name" class="form-group">
   <lable>Subject Order</lable><input type="text" name="subject_name" class="form-group">
