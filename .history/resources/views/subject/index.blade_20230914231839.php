outline-@extends('layouts.mainlayout')
@section('navigation')
    <center>
        <br>
        <br>
...
<table class="table table-light table-striped table table-hover" border="1">
    ...
    <tr>
        ...
        <form action="{{ route('subject.destroy',$subject) }}" method="POST" class="form">
            @csrf
            @method('delete')
        <td><button type="submit" class="btn btn-outline-info"><a class="link-light" href="{{ route('subject.show',$subject) }}">show</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type="submit" class="btn btn-outline-warning"><a class="link-light" href="{{ route('subject.edit',$subject) }}">edit</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
