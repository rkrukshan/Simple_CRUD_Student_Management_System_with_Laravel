...
<table class="table">
    ...
    <tr>
        ...
        <td><button type="submit" class="btn btn-primary"><a class="btn btn-primary btn-lg" href="{{ route('subject.show',$subject) }}">show</button></a></td><td><button type="submit" class="btn btn-primary"><a class="btn btn-primary btn-lg" href="{{ route('subject.edit',$subject) }}">edit</button></a>
    </form>
