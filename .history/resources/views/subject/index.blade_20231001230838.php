...
<table class="table table-striped table table-hover table-responsive">
    ...
    <tr>
        ...
        <td><button type="button" class="btn btn-outline-info btn-lg"><a href="{{ route('subject.show',$subject) }}"><i class="fa fa-eye"></i>show</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="{{ route('subject.edit',$subject) }}"><button type="button" class="btn btn-outline-warning"><i class="fa fa-pencil"></i>edit</button></a><i class="fa fa-pencil"></i>edit</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
