    ...
    <div id="carouselExampleIndicators" class="carousel slide align-center">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="1.jpg" width="550" height="775" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="2.jpg" width="550" height="775" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="3.jpg" width="550" height="775" class="d-block w-100" alt="...">
          </div>
        </div>
