...
<body>
    <table>
        ...
        <tr>
          ...
          <div class=""></div></td>
          <td><br><br><br><br><br><br><br><br><br><br><br><br><br><div class="jumbotron">
            ...
            <p class="lead">
              <a class="btn btn-primary btn-lg" href="http://127.0.0.1:8000/register" role="button">Register Now</a>
            </p>
          </div></td>
        </tr>
