...
<body style="background-image:linear-gradient(rgba(255, 255, 255, 0.719),#565b5c69);">
    <table border="1" class="table nav">
        <td>
            <h1 class=""><a href="{{ route('student.index') }}">Student</a></h1>
            <br>
            <br>
            <br>
            <br>
            ...
            <br>
            <br>
            <h1 class=""><a href="{{ route('house.index') }}">House</a></h1>
            <br>
            <br>
            <br>
            <br>
            ...
            <br>
            <br>
            <h1 class=""><a href="{{ route('grade.index') }}">Grade</a></h1>
        </td>
