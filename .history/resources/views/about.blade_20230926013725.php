    ...
    <div id="carouselExampleIndicators" class="carousel slide align-center">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{asset( '/images/pic1.png') }}" width="550" height="775" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="{{asset( '/images/pic2.png') }}" width="550" height="775" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="{{asset( '/images/pic3.png') }}" width="550" height="775" class="d-block w-100" alt="...">
          </div>
        </div>
