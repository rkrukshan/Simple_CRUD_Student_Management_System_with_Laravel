...
<table border="1">
    ...
    <tr>
        ...
        <td><div class="img-fluid img-thumbnail"><img src="{{ asset('/images/12.jpg') }}" height="150" width="150" alt=""></div></td>
        <td><div class="img-fluid img-thumbnail"><img src="{{ asset('/images/13.jpg') }}" height="150" width="150" alt=""></div></td>
        <td><div class="img-fluid img-thumbnail"><img src="{{ asset('/images/14.jpg') }}" height="150" width="150" alt=""></div></td>
        <td><div class="img-fluid img-thumbnail"><img src="{{ asset('/images/15.jpg') }}" height="150" width="150" alt=""></div></td>
        <td><div class="img-fluid img-thumbnail"><img src="{{ asset('/images/16.jpg') }}" height="150" width="150" alt=""></div></td>
        <td><div class="img-fluid img-thumbnail"><img src="{{ asset('/images/1.jpg') }}" height="150" width="150" alt=""></div></td>
    </tr>
</table>
<br>
<br>
...
<br>
<table>
        <td><h1></h3><img src="{{ asset('/images/11.jpg') }}" height="550" width="750" alt=""></td>&nb
