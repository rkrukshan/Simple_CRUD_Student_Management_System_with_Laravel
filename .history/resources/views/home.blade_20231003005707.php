...
<table class="table">
    <td><h1></h3><img src="{{ asset('/images/13.png') }}" height="550" width="750" alt=""></td>&nbsp;&nbsp;
        <td><div class="jumbotron">
            ...
            <h3>
                <i>
                    <center>"Student Management Systems"</center>
                </i></h3>
            </p>
            <p class="lead">
                <center>
...
<br>
    ...
    <tr>
        <td><h1></h3><img src="{{ asset('/images/14.jpg') }}" height="550" width="750" alt=""></td>&nbsp;&nbsp;
            <td><div class="jumbotron">
                <h1 class="display-4 boxs"><strong>
                        <center>The first-year students' motives for attending university studies and study-related burnout in relation to academic achievement</center>
                    </strong></h1>
                <p class="lead">
                <h5><center>, not longer</center>
                </center></h5>
