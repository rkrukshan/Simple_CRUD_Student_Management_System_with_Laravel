...
<form action="{{ route('student.store') }}" method="POST" class="form">
    ...
    <center>
        <table border="1" class="table">
            ...
            @if($errors->has('admision_number'))
                 <div class="alert alert-danger">
                    <strong style="">{{ $errors->first('admision_number') }}</strong>
                 </strong></div>
            @endif
            ...
            <div class="alert alert-danger"><strong style="">{{ $errors->first('first_name') }}</strong></div>
            @endif
           ...
           @if($errors->has('last_name'))
            <div class="alert alert-danger"><strong style="">{{ $errors->first('last_name') }}</strong></div>
            @endif
        ...
        @if($errors->has('gender'))
            <div class="alert alert-danger" ><strong style="">{{ $errors->first('gender') }}</strong></div>
            @endif
         ...
         @if($errors->has('address'))
            <div class="alert alert-danger"><strong style="">{{ $errors->first('address') }}</strong></div>
            @endif
     ...
     @if($errors->has('dob'))
            <div class="alert alert-danger" ><strong style="">{{ $errors->first('dob') }}</strong></div>
            @endif
      ...
      @if($errors->has('house_id'))
            <div class="alert alert-danger" ><strong style="">{{ $errors->first('house_id') }}</strong></div>
            @endif
            ...
            @if($errors->has('nic'))
            <div class="alert alert-danger">
                <strong style="">{{ $errors->first('nic') }}</strong></div>
            @endif
