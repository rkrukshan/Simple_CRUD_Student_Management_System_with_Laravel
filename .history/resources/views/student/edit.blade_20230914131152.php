...
<form action="{{ route('student.update',$students); }}" method="POST" class="form">
    ...
    <center><button type="submit" name="" id="" class="btn-success btn-lg" value="Save">Save</button>
     <button type="submit" name="" id="" class="btn-secondary btn-lg" value="Back"><a class="link-light" href="{{ route('st') }}">Back</a></button>
     <button type="submit" name="" id="" class="btn-secondary btn-lg" value="Back"><a class="link-light" href="{{ route('st') }}">Back</a></button></center>
