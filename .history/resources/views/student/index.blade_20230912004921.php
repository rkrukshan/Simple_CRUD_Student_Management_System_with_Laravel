        ...
        <td>
            <table border="1" class="table">
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-warning"><a href="" class="link-light">edit</a></button>
                    </td>
                    <td><button type="button" class="btn btn-danger"><a href="" class="link-light">delete</a></button>
                    </td>
                </tr>
                @endforeach
            </table>
