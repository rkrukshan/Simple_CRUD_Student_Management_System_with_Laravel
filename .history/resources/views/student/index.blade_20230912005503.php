            ...
            <table border="1" class="table">
                ...
                <tr>
                    ...
                    <form action="route('student.destroy,$student')">
                        <td><button type="button" class="btn btn-info"><a href="{{ route('student.show',$student->id) }}" class="link-light">show</a></button></td>
                        <td><button type="button" class="btn btn-warning"><a href="{{ route('') }}"class="link-light">edit</a></button></td>
                        <td><button type="button" class="btn btn-danger"><a href="{{ route('') }}"class="link-light">delete</a></button></td>
                    </form>
                </tr>
                @endforeach
            </table>
