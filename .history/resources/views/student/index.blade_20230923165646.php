    ...
    <table border="1" class="table table-striped table table-hover table-responsive">
        ...
        <td>
                ...
                <tr>
                    ...
                    <td>{{ $student->nic }}</td>
                    <td><a href="{{ route('student.subject.show',[$student,50]) }}">Subject</a></td>
                    <td><a class="link-light" href="{{ route('student.show',$student) }}">
                        ...
                        <button type="button" class="btn-outline-info btn-lg">show</button></a>
                         ...
                         <a class="link-light-" href="{{ route('student.edit',$student) }}"><button type="button" class="btn-outline-warning btn-lg">edit</button></a>
