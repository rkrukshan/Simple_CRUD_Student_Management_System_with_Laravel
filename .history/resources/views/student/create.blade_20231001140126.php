        ...
        <table border="1" class="table">
            ...
            @if($errors->has('admision_number'))
                 <div class="alert alert-danger">
                    ...
                    <strong style="color: red">{{ $errors->first('admision_number')&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i> }}</strong>
                 </strong></div>
            @endif
            ...
            <div class="alert alert-danger">
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('first_name') }}</stro&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i>ng></div>
            @endif
           ...
           @if($errors->has('last_name'))
            <div class="alert alert-danger">
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('last_name') }}</stron&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i>g></div>
            @endif
...
&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i>                &nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i>
            </div>
            @endif
         ...
         @if($errors->has('address'))
            <div class="alert alert-danger">
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('address') }}</strong>&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i></div>
            @endif
     ...
     @if($errors->has('dob'))
            <div class="alert alert-danger" >
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('dob') }}</strong></di&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i>v>
            @endif
      ...
      @if($errors->has('house_id'))
            <div class="alert alert-danger" >
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('house_id') }}</strong&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i>></div>
            @endif
            ...
            <div class="alert alert-danger">
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('nic') }}</strong></di&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i>v>
            @endif
