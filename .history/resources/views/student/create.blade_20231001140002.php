...
<form action="{{ route('student.store') }}" method="POST" class="form">
    ...
    <center>
        <table border="1" class="table">
            ...
            <div class="alert alert-danger">
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('first_name') }}</strong></div>
            @endif
           ...
           @if($errors->has('last_name'))
            <div class="alert alert-danger">
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('last_name') }}</strong></div>
            @endif
        ...
        @if($errors->has('gender'))
            <div class="alert alert-danger" >
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('gender') }}</strong></div>
            @endif
         ...
         @if($errors->has('address'))
            <div class="alert alert-danger">
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('address') }}</strong></div>
            @endif
     ...
     @if($errors->has('dob'))
            <div class="alert alert-danger" >
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('dob') }}</strong></div>
            @endif
      ...
      @if($errors->has('house_id'))
            <div class="alert alert-danger" >
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <strong style="color: red">{{ $errors->first('house_id') }}</strong></div>
            @endif
