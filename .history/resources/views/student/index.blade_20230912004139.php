...
<body>
    ...
    <table border="1" class="table">
        <center><button type="" class="btn btn-primary"><a href="{{ route('student.create') }}">Create</a></button></center>
        <td>
        ...
        <td>
            <table border="1" class="table">
                ...
                <tr>
                    ...
                    <td>{{ $student->nic }}</td>
                    <td><button type="" class="btn btn-info"><a href="">show</a></button></td>
                    <td><button type="" class="btn btn-warning"><a href="">edit</a></button></td>
                    <td><button type="" class="btn btn-danger"><a href="">delete</a></button></td>
                </tr>
                @endforeach
            </table>
        </td>
