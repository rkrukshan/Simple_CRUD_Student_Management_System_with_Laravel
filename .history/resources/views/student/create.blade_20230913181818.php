...
@section('navigation')
<form action="{{ route('student.store') }}" method="GET" class="form">
    {{--  @csrf  --}}
    <center>
    ...
    <center><button type="submit" name="" id="" class="btn-success" value="Save">Save</button>
        <a href="{{ route('student.index') }}"> <button type="submit" name="" id="" class=""value="Back">Back</button></a>
    </center>
