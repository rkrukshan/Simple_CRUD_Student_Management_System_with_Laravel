...
<form action="{{ route('student.store') }}" method="POST" class="form">
    ...
    <center>
        <table border="1" class="table">
            ...
            <div class="alert alert-danger"><i class="fa-solid fa-circle-radiation fa-sm" style="color: #ffffff;"></i><strong style="color: red">{{ $errors->first('first_name') }}</strong></div>
            @endif
