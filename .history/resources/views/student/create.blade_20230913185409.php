...
<form action="{{ route('student.store') }}" method="POST" class="form">
    ...
    <center><button type="submit" name="" id="" class="btn-successbtn-lg" value="Save">Save</button>
        <a href="{{ route('student.index') }}"> <button type="submit" name="" id="" class="btn btn-secondary btn-lg"value="Back">Back</button></a>
    </center>
