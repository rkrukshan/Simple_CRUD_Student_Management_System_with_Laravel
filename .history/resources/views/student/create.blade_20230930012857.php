...
<form action="{{ route('student.store') }}" method="POST" class="form">
    ...
    <center>
        <table border="1" class="table">
            ...
            <div class="alert alert-danger"><strong>{{ $errors->first('first_name') }}</div>
            @endif
           ...
           @if($errors->has('last_name'))
            <div class="alert alert-danger"><strong>{{ $errors->first('last_name') }}</div>
            @endif
        ...
        @if($errors->has('gender'))
            <div class="alert alert-danger" ><strong>{{ $errors->first('gender') }}</div>
            @endif
         ...
         @if($errors->has('address'))
            <div class="alert alert-danger"><strong>{{ $errors->first('address') }}</div>
            @endif
     ...
     @if($errors->has('dob'))
            <div class="alert alert-danger" ><strong>{{ $errors->first('dob') }}</div>
            @endif
      ...
      @if($errors->has('house_id'))
            <div class="alert alert-danger" ><strong>{{ $errors->first('house_id') }}</div>
            @endif
