        ...
        <tr>
            <center>
                <form action="{{ route('student.destroy',$student) }}" method="POST" class="form">
                    ...
                    <td><a href="{{ route('grade.show',$student->grade->id) }}">{{ $student->grade->grade_name }}</a>
                    </td>
                    <td>{{ $student->nic }}</td>
                    <td><a href="{{ route('student.subject.show',[$student->id,50]) }}">Subject</a></td>
                    <td><a class="link-light" href="{{ route('student.show',$student) }}">

                            <button type="button"
                                class="btn-outline-info btn-lg">show</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        {{--
                    ...
                    <a class="link-light-" href="{{ route('student.edit',$student) }}">
                        ...
                        <button type="button"
                            class="btn-outline-warning btn-lg">edit</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
