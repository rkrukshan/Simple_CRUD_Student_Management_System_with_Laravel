...
<form action="{{ route('student.store') }}" method="POST" class="form">
    ...
    <center>
        <table border="1" class="table">
            ...
            <div class="alert alert-danger">
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <stro&nbsp;&nbsp;&nbsp; style="color: red">{{ $errors->first('first_name') }}</stro&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i>ng></div>
            @endif
           ...
           @if($errors->has('last_name'))
            <div class="alert alert-danger">
                <i class="fa fa-warning" style="color: #000000;"></i>&nbsp;&nbsp;&nbsp;
                <stron&nbsp;&nbsp;&nbsp; style="color: red">{{ $errors->first('last_name') }}</stron&nbsp;&nbsp;&nbsp;<i class="fa fa-warning" style="color: #000000;"></i>g></div>
            @endif
