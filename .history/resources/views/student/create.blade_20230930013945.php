    ...
    <center>
        ...
        @if($errors->has('gender'))
         ...
         @if($errors->has('address'))
            ...
            <label for="dob">dob</label><input type="date" name="dob" id="" class="form-control" value="{{  }}"><br>
     @if($errors->has('dob'))
      ...
      @if($errors->has('house_id'))
            ...
            {{--  <input type="text" name="house_id" id="form-control" value="{{  }}"class="form-control" value="{{  }}">  --}}
            ...
            {{--  <input type="text" name="grade_id" id="form-control" value="{{  }}"class="form-control" value="{{  }}">  --}}
