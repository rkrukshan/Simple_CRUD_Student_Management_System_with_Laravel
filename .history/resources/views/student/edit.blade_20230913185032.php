...
<form action="{{ route('student.update',$students); }}" method="POST" class="form">
    ...
    center_focus_weak<button type="submit" name="" id="" class="btn-success" value="Save">Save</button>
     <button type="submit" name="" id="" class="btn-secondary" value="Back"><a class="link-light" href="http://127.0.0.1:8000/student">Back</a></button>
