    ...
    <table border="1" class="table table-striped table table-hover table-responsive">
        ...
        <td>
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn-info btn-lg"><a href="{{ route('student.show',$student) }}"
                                class="link-light">show</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                    <button type="button" class="btn-warning btn-lg"><a href="{{ route('student.edit',$student) }}"
                                class="link-light">edit</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="submit" class="btn-danger btn-lg" value="save">delete</button></td>
