    ...
    <center>
        <table border="1" class="table">
            ...
            <div class="alert alert-danger d-flex align-items-center" role="alert">
                 <center>{{ $errors->first('admision_number') }}</center></div>

            @endif

            <label for="first_name">first name</label><input type="text" name="first_name" id=""class="form-control"><br>
            @if($errors->has('first_name'))
            <div class="alert alert-danger d-flex align-items-center">{{ $errors->first('first_name') }}</div>
            @endif

            <label for="last_name">last name</label><input type="text" name="last_name" id="" class="form-control"><br>
           @if($errors->has('last_name'))
            <div class="alert alert-danger d-flex align-items-center">{{ $errors->first('last_name') }}</div>
            @endif
        ...
        @if($errors->has('gender'))
            <div class="alert alert-danger d-flex align-items-center" >{{ $errors->first('gender') }}</div>
            @endif

            <label for="address">Address</label><input type="text" name="address" id="" class="form-control"><br>
         @if($errors->has('address'))
            <div class="alert alert-danger d-flex align-items-center">{{ $errors->first('address') }}</div>
            @endif

            <label for="dob">dob</label><input type="date" name="dob" id="" class="form-control"><br>
     @if($errors->has('dob'))
            <div class="alert alert-danger d-flex align-items-center" >{{ $errors->first('dob') }}</div>
            @endif
      ...
      @if($errors->has('house_id'))
            <div class="alert alert-danger d-flex align-items-center" >{{ $errors->first('house_id') }}</div>
            @endif
