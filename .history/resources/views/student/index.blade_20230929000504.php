...
<html lang="en">
    ...
    <table border="1" class="table table-striped table table-hover table-responsive">
        ...
        <br>
        <center>
            <button type="button" class="btn btn-primary"><a href="{{ route('student.create') }}"
                    class="link-light">Create</a></button>
                </center>
        <br>
        ...
        <td>
                ...
                <tr>
                    ...
                    <td><a  class="badge badge-pill badge-dark a link-dark"  href="{{ route('grade.show',$student->grade->id) }}">{{ $student->grade->grade_name }}</a></td>
                    <td>{{ $student->nic }}</td>
                    <td><a  class="badge badge rounded-pill bg-success a link-light" href="{{ route('student.subject.show',[$student,50]) }}">Subject</a></td>
                    <td><a class="link-light" href="{{ route('student.show',$student) }}">
                        <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-outline-info">show</button></a><br>
                    ...
                    <button type="button" class="btn btn-outline-warning">edit</button></a><br>
                    <button type="submit" class="btn btn-outline-danger" value="save">delete</button></td>
