            ...
            <table border="1" class="table">
                ...
                <tr>
                    ...
                    <form action="route('student.destroy,$student')">
                        <td><button type="button" class="btn btn-info"><a href="{{ ro }}" class="link-light">show</a></button></td>
                        <td><button type="button" class="btn btn-warning"><a href="{{ ro }}"class="link-light">edit</a></button></td>
                        <td><button type="button" class="btn btn-danger"><a href="{{ ro }}"class="link-light">delete</a></button></td>
                    </form>
                </tr>
                @endforeach
            </table>
