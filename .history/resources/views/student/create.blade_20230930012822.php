...
<form action="{{ route('student.store') }}" method="POST" class="form">
    ...
    <center>
        <table border="1" class="table">
            ...
            @if($errors->has('admision_number'))
                 <div class="alert alert-danger">
                    {{ <strong></strong>$errors->first('admision_number') }}
                 </div>
            @endif
            ...
            <div class="alert alert-danger">{{ <strong></strong>$errors->first('first_name') }}</div>
            @endif
           ...
           @if($errors->has('last_name'))
            <div class="alert alert-danger">{{ <strong></strong>$errors->first('last_name') }}</div>
            @endif
        ...
        @if($errors->has('gender'))
            <div class="alert alert-danger" >{{ <strong></strong>$errors->first('gender') }}</div>
            @endif
         ...
         @if($errors->has('address'))
            <div class="alert alert-danger">{{ <strong></strong>$errors->first('address') }}</div>
            @endif
     ...
     @if($errors->has('dob'))
            <div class="alert alert-danger" >{{ <strong></strong>$errors->first('dob') }}</div>
            @endif
      ...
      @if($errors->has('house_id'))
            <div class="alert alert-danger" >{{ <strong></strong>$errors->first('house_id') }}</div>
            @endif
            ...
            @if($errors->has('nic'))
            <div class="alert alert-danger">
                {{ <strong></strong>$errors->first('nic') }}</div>
            @endif
