...
<form action="{{ route('student.store') }}" method="POST" class="form">
    ...
    <center>
        <table border="1" class="table">
            ...
            <center></center><div class="alert alert-danger d-flex align-items-center" role="alert">
                <i class="fa-solid fa-shield-halved fa-sm">{{ $errors->first('admision_number') }}</i></div>
