    ...
    <table border="1" class="table table-striped table table-hover table-responsive">
        ...
        <td>
                ...
                <tr>
                    ...
                    <button type="button" class="btn-outline-info btn-lg">show</button></a><br>
                    ...
                    <button type="button" class="btn btn-outline-primary">edit</button></a><br>
                    <button type="submit" class="btn btn-outline-primary" value="save">delete</button></td>
