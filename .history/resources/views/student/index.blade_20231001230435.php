                ...
                <form action="{{ route('student.destroy',$student) }}" method="POST" class="form">
                    ...
                    <td><a class="link-light" href="{{ route('student.show',$student) }}">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <button type="button" class="btn btn-outline-info"><i class="fa fa-eye"></i>show</button>
                        </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        {{--
                    ...
                    <a class="link-light" href="{{ route('student.edit',$student) }}">
                        <button type="button" class="btn btn-outline-warning"><i class="fa fa-pencil"></i>edit</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="submit" class="btn btn-outline-danger" value="save"><i class="fas fa-trash"></i>delete</button>
    </td>
