    ...
    <table border="1" class="table table-striped table table-hover table-responsive">
        ...
        <td>
                ...
                <tr>
                    ...
                    <td><a  class="badge badge-pill badge-dark a link-dark"  href="{{ route('grade.show',$student->grade->id) }}"><h5>click->{{ $student->grade->grade_name }}</h5></a></td>
                    <td>{{ $student->nic }}</td>
                    <td><a  class="badge badge rounded-pill bg-success a link-light" href="{{ route('student.subject.show',[$subjects,50]) }}">Subject</a></td>
