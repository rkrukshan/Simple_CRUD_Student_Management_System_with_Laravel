            ...
            <table border="1" class="table">
                ...
                <tr>
                    ...
                    <form action="{{ route('student.destroy',$student) }}" method="POST">
                        @csrf
                        @method('delete')
                        <td><button type="button" class="btn btn-info"><a href="{{ route('student.show',$student) }}"
                        ...
                        {{-- <td><button type="button" class="btn btn-info"><a
                                    ...
                                    class="link-light">show</a></button></td> --}}
                        <td><button type="button" class="btn btn-warning"><a href="{{ route('student.edit',$student) }}"
