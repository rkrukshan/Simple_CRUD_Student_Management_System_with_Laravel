...
<body>
    ...
    <br>
    <br>
    <center><button class="btn-primary"><a href="{{ route('student.create') }}">Create</a></button></center>
        ...
        <td>
            <table border="1" class="table">
                ...
                <tr>
                    ...
                    <td>{{ $student->nic }}</td>
                    <td><button class="btn-info"><a href="">show</a></button></td>
                    <td><button class="btn-warning"><a href="">edit</a></button></td>
                    <td><button class="btn-danger"><a href="">delete</a></button></td>
                </tr>
                @endforeach
            </table>
        </td>
