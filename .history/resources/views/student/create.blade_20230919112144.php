...
<form action="{{ route('student.store') }}" method="POST" class="form">
    @csrf
        ...
        <label for="house_id">House</label> &nbsp; <button type="button" class="badge rounded-pill bg-primary"><a class="link-light" href="{{ route('house.create') }}"> Create House</a></button> <br>
