...
<form action="{{ route('student.store') }}" method="POST" class="form">
    ...
    <center>
        <table border="1" class="table">
            <label for="admision_number">Admision Number</label><input type="text" name="admision_number" id=""class="form-control val"><br>
            ...
            <label for="first_name">first name</label><input type="text" name="first_name" id=""class="form-control val"><br>
            ...
            <label for="last_name">last name</label><input type="text" name="last_name" id="" class="form-control val"><br>
        ...
        @if($errors->has('gender'))
            ...
            <label for="address">Address</label><input type="text" name="address" id="" class="form-control val"><br>
         @if($errors->has('address'))
            ...
            <label for="dob">dob</label><input type="date" name="dob" id="" class="form-control val"><br>
     @if($errors->has('dob'))
      ...
      @if($errors->has('house_id'))
            ...
            {{--  <input type="text" name="house_id" id="form-control val"class="form-control val">  --}}
            ...
            {{--  <input type="text" name="grade_id" id="form-control val"class="form-control val">  --}}
            ...
            <label for="nic">NIC</label><input type="text" name="nic" id="" class="form-control val"><br>
            @if($errors->has('nic'))
            <div class="alert alert-danger">
