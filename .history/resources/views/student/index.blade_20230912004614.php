        ...
        <td>
            <table border="1" class="table">
                ...
                <tr>
                    ...
                    <td>{{ $student->nic }}</td>
                    <td><button type="button" class="btn btn-info"><a href=""  class="link-primary">show</a></button></td>
                    <td><button type="button" class="btn btn-warning"><a href=""  class="link-primary">edit</a></button></td>
                    <td><button type="button" class="btn btn-danger"><a href=""  class="link-primary">delete</a></button></td>
                </tr>
                @endforeach
            </table>
        </td>
