    ...
    <table border="1" class="table table-striped table table-hover table-responsive">
        ...
        <td>
                ...
                <tr>
                    ...
                    <td><a  class="badge badge-pill badge-dark"  class="badge badge-pill badge-light" href="{{ route('grade.show',$student->grade->id) }}">{{ $student->grade->grade_name }}</a></td>
                    <td>{{ $student->nic }}</td>
                    <td><a  class="badge badge rounded-pill bg-info" href="{{ route('student.subject.show',[$student,50]) }}">Subject</a></td>
