...
<table class="table">
<label for="admision_number">   </label><input type="text" name="admision_number" id="" class="" >
...
<label for="house_id">House Id</label><input type="text" name="house_id" id="" class="" >
<label for="group_id">Group Id</label><input type="text" name="group_id" id="" class="" >
