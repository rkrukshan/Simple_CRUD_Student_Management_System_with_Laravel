...
<center>
    ...
    <body>
        <form action=" {{ route('grade.store') }}" class="form" method="POST">
            ...
            <table class="=table">
                <center>
                    <label for="grade_group">Grade Group</label></td><input type="text" name="grade_group"class="form-control" value=""><br>
                    ...
                    <label for="grade_name">Grade Name</label><input type="text" name="grade_name"class="form-control" value=""><br>
                    ...
                    <label for="grade_order">Grade Order</label><input type="text" name="grade_order"class="form-control" value=""><br>
