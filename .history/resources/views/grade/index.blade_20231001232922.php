...
<form action="{{ route('grade.destroy',$grade) }}"method="POST">
    ...
    <td><a href="{{ route('grade.show',$grade) }}"><button type="button" class="btn btn-outline-info btn-lg">show</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="{{ route('grade.edit',$grade) }}"><button type="button" class="btn btn-outline-warning btn-lg">edit</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
