    ...
    <table border="1" class="table table-striped table table-hover table-responsive">
        ...
        <td>
                ...
                <tr>
                    ...
                    <td><a href="{{ route('student.show',$student) }}"
                        <button type="button" class="btn btn-outline-info btn-lg"><i class="fa fa-eye"></i>show</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                    <a href="{{ route('student.edit',$student) }}"
                    <button type="button" class="btn btn-outline-warning btn-lg"><i class="fa fa-pencil"></i>edit</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="submit" class="btn btn-outline-danger btn-lg" value="save"><i class="fa fa-trash"></i>delete</button></td>
        ...
        <a class="link-light" href="{{ route('grade.index') }}"><button type="button" class="btn-outline-secondary btn-lg" value="Back">Back</button></a>
