...
<table class="table">
    <td><h1></h3><img src="{{ asset('/images/13.png') }}" height="550" width="750" alt=""></td>&nbsp;&nbsp;
        <td><div class="jumbotron">
            ...
            <p class="lead">
                <center>
                    <a class="btn btn-outline-success btn-lg link-dark" href="{{ url('https://www.softwaresuggest.com/student-management-system') }}"
    ...
    <tr>
        <td><h1></h3><img src="{{ asset('/images/12.jpg') }}" height="550" width="750" alt=""></td>&nbsp;&nbsp;
            <td><div class="jumbotron">
                ...
                <p class="lead">
                    <center>
                        <a class="btn btn-outline-success btn-lg link-dark" href="{{ url('https://www.snexplores.org/article/top-10-tips-study-smarter-not-longer-study-skills') }}"
                            role="button">Read More</a>
                    </center>
                </p>
            </div></td>
    ...
    <tr>
        <td><h1></h3><img src="{{ asset('/images/15.jpg') }}" height="550" width="750" alt=""></td>&nbsp;&nbsp;
            <td><div class="jumbotron">
                ...
                <p class="lead">
                    <center>
                        <a class="btn btn-outline-success btn-lg link-dark" href="{{ url('https://www.sciencedirect.com/science/article/pii/S1041608022000528') }}"
                            role="button">Read More</a>
                    </center>
                </p>
            </div></td>
    ...
    <tr>
        <td><h1></h3><img src="{{ asset('/images/14.jpg') }}" height="550" width="750" alt=""></td>&nbsp;&nbsp;
            <td><div class="jumbotron">
                ...
                <p class="lead">
                    <center>
                        <a class="btn btn-outline-success btn-lg link-dark" href="{{ url('https://blog.ejoy-english.com/the-difference-between-learn-and-study/') }}"
                            role="button">Read More</a>
                    </center>
                </p>
            </div></td>
    ...
    <tr>
        <td><h1></h3><img src="{{ asset('/images/16.jpg') }}" height="550" width="750" alt=""></td>&nbsp;&nbsp;
            <td><div class="jumbotron">
                ...
                <p class="lead">
                    <center>
                        <a class="btn btn-outline-success btn-lg link-dark" href="{{ url('https://www.studysmarter.co.uk/magazine/study-guide/') }}"
                            role="button">Read More</a>
                    </center>
                </p>
            </div></td>
