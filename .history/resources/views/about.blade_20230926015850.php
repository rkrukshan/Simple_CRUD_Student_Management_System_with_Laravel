    ...
    <div id="carouselExampleIndicators" class="carousel slide align-center">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="{{asset( '/images/pic1.jpg') }}" width="455" height="775" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="{{asset( '/images/pic2.jpg') }}" width="455" height="775" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="{{asset( '/images/pic3.jpg') }}" width="455" height="775" class="d-block w-100" alt="...">
          </div>
        </div>
      ...
      <tr>
        <td width=25%></td>
      <td width="50%"><h3><p><center>A school management system sounds like it is interchangeable with student management, but the difference comes from what information you manage:</td>
