...
<br>
    ...
    <tr>
        <td><h1></h3><img src="{{ asset('/images/14.jpg') }}" height="550" width="750" alt=""></td>&nbsp;&nbsp;
            <td><div class="jumbotron">
                ...
                <p class="lead">
                    <center>
                        <a class="btn btn-info btn-lg link-light" href="{{ url('https://blog.ejoy-english.com/the-difference-between-learn-and-study/') }}"
                            role="button">Read More</a>
                    </center>
                </p>
            </div></td>
    ...
    <tr>
        <td><h1></h3><img src="{{ asset('/images/14.jpg') }}" height="550" width="750" alt=""></td>&nbsp;&nbsp;
            <td><div class="jumbotron">
                <h1 class="display-4 boxs"><strong>
                        <centerThe Difference between LEARN and STU>DY</centerThe>
                    </strong></h1>
                <p class="lead">
                <h5><center>What are the main differences between LEARN and STUDY? This is a question which many people ask us, especially for those of you who are learning or studying English.</center>
                </center></h5>
                ...
                <p class="lead">
                    <center>
                        <a class="btn btn-info btn-lg link-light" href="{{ url('https://www.studysmarter.co.uk/magazine/study-guide/') }}"
                            role="button">Read More</a>
                    </center>
                </p>
            </div></td>
