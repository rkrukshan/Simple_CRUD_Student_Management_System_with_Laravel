...
{{--  @section('navigation')  --}}
    <table>
        ...
        <tr>
            ...
            <div>
                <center>
            <ul class="list-group-item list-group-item-action active" style="list-style-type: none; background: grey; color: white; padding:50;">
                <li>Home</li>
                <li>About</li>
                <li>Services</li>
                <li>Portfolio</li>
        ...
        <div>
            <center>
            class="list-group-item list-group-item-action active" <ul style="list-style-type: none; background: grey; color: white; padding:50;">
                <li>Home</li>
                <li>About</li>
                <li>Services</li>
                <li>Portfolio</li>
